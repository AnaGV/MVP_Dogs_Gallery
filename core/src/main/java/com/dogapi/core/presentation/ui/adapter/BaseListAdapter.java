...
public abstract class BaseListAdapter<T,V extends BaseViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected com.dogapi.core.presentation.ui.adapter.OnItemClickListener<T> onItemClickListener;
    ...
    public BaseListAdapter(List<T> list, com.dogapi.core.presentation.ui.adapter.OnItemClickListener<T> listener) {
        this.list=list;
    ...
    public void setOnItemClickListener(com.dogapi.core.presentation.ui.adapter.OnItemClickListener<T> onItemClickListener) {
